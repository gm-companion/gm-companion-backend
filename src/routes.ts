...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/spotify/login',
            ...(fetchMiddlewares<RequestHandler>(SpotifyController)),
            ...(fetchMiddlewares<RequestHandler>(SpotifyController.prototype.login)),

            function SpotifyController_login(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/spotify/token',
            ...(fetchMiddlewares<RequestHandler>(SpotifyController)),
            ...(fetchMiddlewares<RequestHandler>(SpotifyController.prototype.token)),

            function SpotifyController_token(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/spotify/refresh',
            ...(fetchMiddlewares<RequestHandler>(SpotifyController)),
            ...(fetchMiddlewares<RequestHandler>(SpotifyController.prototype.refresh)),

            function SpotifyController_refresh(request: any, response: any, next: any) {
            const args = {
